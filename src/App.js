...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav-link-e {
    font-family: 'DM Mono', monospace;
    font-size: 15px; font-weight: 500; letter-spacing: 0px;
  ...
  /* ── MOBILE ── */
    ...
    .m-stack { flex-direction: column !important; gap: 24px !important; }
    ...
    .m-text-sm { font-size: clamp(40px, 11vw, 72px) !important; }

    /* Single column everything on mobile */
    .before-after-grid { grid-template-columns: 1fr !important; gap: 12px !important; background: transparent !important; }
    .feat-grid { grid-template-columns: 1fr !important; gap: 12px !important; background: transparent !important; }
    .industry-grid { grid-template-columns: repeat(2, 1fr) !important; gap: 10px !important; background: transparent !important; }
    .testimonial-grid { grid-template-columns: 1fr !important; gap: 12px !important; background: transparent !important; }
    ...
    /* Buttons full width */
    .btn-elite, .btn-wire { width: 100% !important; justify-content: center !important; font-size: 15px !important; padding: 16px 24px !important; }

    /* Sections close to screen */
    section { padding-left: 20px !important; padding-right: 20px !important; }

    /* Hide decorative elements on mobile */
    .feat-elite::before, .feat-elite::after { display: none; }
  }
...
export default function Landing() {
  ...
  return (
    <>
          ...
          <div style={{ flex: "1 1 400px" }}>
            <Rise>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 36 }}>
                ...
                <span className="mono" style={{ fontSize: 16, color: "var(--gold)", letterSpacing: 2, textTransform: "uppercase" }}>Zambian-Built WhatsApp Automation Platform</span>
              </div>
            </Rise>
            <Rise delay={0.1}>
            ...
            <Rise delay={0.4}>
              <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
                {["📱 Airtel Money","📱 MTN Money","📱 Zamtel Money","💳 Visa / Mastercard","🇿🇲 Lusaka Support"].map(t => (
                  <span key={t} style={{ fontSize: 16, color: "var(--text3)" }}>{t}</span>
                ))}
              </div>
            </Rise>
          </div>
      ...
      {/* ── TICKER ── */}
      <div style={{ background: "var(--bg2)", borderTop: "1px solid var(--wire)", borderBottom: "1px solid var(--line)", padding: "12px 0", overflow: "hidden" }}>
        <div className="marquee-inner">
          {[...TICKER,...TICKER].map((t,i) => (
            <span key={i} style={{ color: i%3===0 ? "var(--gold)" : "var(--text3)", fontSize: 16, fontWeight: 500, fontFamily: "DM Mono, monospace", letterSpacing: 2, textTransform: "uppercase", padding: "0 32px", whiteSpace: "nowrap" }}>
              {t}
            </span>
          ))}
        </div>
              ...
              <Rise key={i} delay={i*0.08} style={{ minWidth: 260, flex: "1 1 260px" }}>
                <div style={{ background: "var(--bg)", height: "100%" }}>
                  <div style={{ padding: "24px 28px", borderBottom: "1px solid var(--line)" }}>
                    ...
                    <p style={{ color: "rgba(0,0,0,0.4)", fontSize: 16, lineHeight: 1.7, textDecoration: "line-through" }}>{p.b}</p>
                  </div>
              ...
              <Rise key={i} delay={i*0.07}>
                <div className="feat-elite">
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
                    ...
                    <span className="mono" style={{ fontSize: 16, color: "rgba(255,255,255,0.08)", fontWeight: 500 }}>{f.n}</span>
                  </div>
                  <h3 className="editorial" style={{ fontSize: 16, color: "var(--text1)", marginBottom: 10, lineHeight: 1.2, fontWeight: 600 }}>{f.title}</h3>
                  <p style={{ fontSize: 16, color: "var(--text2)", lineHeight: 1.8 }}>{f.body}</p>
                </div>
              </Rise>
            ))}
          </div>
            ...
            {INDUSTRIES.map((v,i) => (
              <Rise key={i} delay={i*0.04}>
                <div className="industry-elite">
                  <div style={{ fontSize: 16, marginBottom: 10 }}>{v.e}</div>
                  <div style={{ fontSize: 16, fontWeight: 700, color: "var(--text1)", marginBottom: 6 }}>{v.n}</div>
                  <div style={{ fontSize: 16, color: "var(--mist)", lineHeight: 1.6 }}>{v.t}</div>
                </div>
              </Rise>
            ))}
          </div>
      ...
      <section id="pricing" style={{ background: "var(--bg)", padding: "clamp(64px,8vw,120px) 40px", borderTop: "1px solid var(--wire)" }} className="m-pad">
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <Rise>
            ...
            <p style={{ fontSize: 16, color: "var(--mist)", marginBottom: 56, opacity: 0.6, fontFamily: "DM Mono, monospace", letterSpacing: 1 }}>
              ...
              <Rise key={i} delay={i*0.1}>
                <div className="card-elite" style={{ padding: "36px 28px", background: "var(--bg2)" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                    ...
                    <div>
                      <div style={{ color: "var(--text1)", fontSize: 16, fontWeight: 700 }}>{t.n}</div>
                      <div className="mono" style={{ color: "var(--text1)", fontSize: 16, marginTop: 2 }}>{t.o}</div>
                    </div>
                  </div>
                </div>
              </Rise>
            ...
            <Rise key={i} delay={i*0.04}>
              <div className="faq-elite" onClick={() => setOpenFaq(openFaq===i ? null : i)}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px 0", gap: 20 }}>
                  <span style={{ color: "var(--text1)", fontSize: 16, fontWeight: 400, lineHeight: 1.4 }}>{f.q}</span>
                  <span className="editorial" style={{ color: openFaq===i ? "var(--gold2)" : "var(--mist)", fontSize: 16, fontWeight: 300, flexShrink: 0, transition: "all 0.3s" }}>{openFaq===i ? "−" : "+"}</span>
                </div>
                {openFaq===i && (
                  <div style={{ paddingBottom: 20 }}>
                    <p style={{ color: "var(--text1)", fontSize: 16, lineHeight: 1.85 }}>{f.a}</p>
                  </div>
                )}
              </div>
            </Rise>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", display: "flex", gap: 80, alignItems: "flex-start", flexWrap: "wrap" }} >
          <div style={{ flex: "1 1 380px" }}>
            <Rise>
              ...
              <p style={{ fontSize: 17, color: "var(--text2)", lineHeight: 1.9, marginBottom: 20 }}>
                ZedPing is Zambian-built WhatsApp automation platform built specifically for local SMEs. We exist because Zambian businesses deserve world-class communication tools — priced in Kwacha, supported locally, and built to understand the way businesses here actually operate.
              </p>
              <p style={{ fontSize: 17, color: "var(--text2)", lineHeight: 1.9, marginBottom: 32 }}>
              ...
              <div style={{ background: "var(--bg2)", border: "1px solid var(--line)", padding: "20px 24px", position: "relative" }}>
                ...
                <div className="editorial" style={{ fontSize: 16, color: "var(--green)", fontWeight: 700, marginBottom: 6 }}>Coreline Systems</div>
                <p style={{ fontSize: 16, color: "var(--mist)", lineHeight: 1.7 }}>Coreline Systems is a business systems consultancy based in Lusaka, Zambia — helping businesses build structured systems and streamlined operations. ZedPing is our first SaaS product.</p>
              </div>
            </Rise>
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20, marginBottom: 48 }}>
              {[
                ...
                <div key={i}>
                  ...
                  <p style={{ fontSize: 16, color: "var(--text1)", fontSize: 16, lineHeight: 1.85 }}>{s.body}</p>
                </div>
              ))}
            </div>
          </Rise>
      ...
      <section style={{ background: "var(--bg2)", padding: "clamp(80px,10vw,140px) 40px", position: "relative", overflow: "hidden" }} className="m-pad">
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <Rise delay={0.2}>
            <p style={{ fontSize: 16, color: "var(--text1)", lineHeight: 1.85, maxWidth: 520, margin: "0 auto 48px" }}>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 40, marginBottom: 40 }}>
            <div style={{ maxWidth: 260 }}>
              ...
              <p style={{ color: "var(--text1)", fontSize: 16, lineHeight: 1.8 }}>
                Zambian-built WhatsApp automation platform. Built for SMEs. Priced in Kwacha.
              </p>
            </div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
            <p className="mono" style={{ color: "var(--text1)", fontSize: 16, letterSpacing: 1 }}>© 2026 ZedPing · A product of Coreline Systems · Lusaka, Zambia</p>
            <p className="editorial" style={{ color: "var(--text1)", fontSize: 16, fontStyle: "italic" }}>Your business, on autopilot.</p>
          </div>
        </div>
      </footer>
    </>
